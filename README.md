...
```PowerShell
java -cp .\target\bigdatakaf-ravi-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.devulapally.Consumer
```
...
```PowerShell
java -cp .\target\bigdatakaf-ravi-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.devulapally.Producer
```
